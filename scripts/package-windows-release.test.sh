...
assert_contains "$INSTALLER_VALIDATOR" 'Uninstallation removed a user-owned file'
assert_contains "$INSTALLER_VALIDATOR" 'Windows installer lifecycle tests passed.'

assert_not_contains "$INSTALLER_TEMPLATE" 'RMDir /r $INSTDIR'
assert_contains "$INSTALLER_TEMPLATE" 'Delete "$INSTDIR\${PRODUCT_EXECUTABLE}"'
assert_contains "$INSTALLER_TEMPLATE" 'Delete "$INSTDIR\${PRODUCT_EXECUTABLE}.new"'
assert_contains "$INSTALLER_TEMPLATE" 'Delete "$INSTDIR\${PRODUCT_EXECUTABLE}.old"'
assert_contains "$INSTALLER_TEMPLATE" 'RMDir "$INSTDIR"'
