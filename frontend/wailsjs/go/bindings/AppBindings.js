...
export function ActivateRunningBrowser(arg1) {
...
export function ListRunningBrowsers() {
  return window['go']['bindings']['AppBindings']['ListRunningBrowsers']();
}
...
export function SetBrowserSwitcherPresenter(arg1) {
  return window['go']['bindings']['AppBindings']['SetBrowserSwitcherPresenter'](arg1);
}
...
export function ShowBrowserSwitcher() {
  return window['go']['bindings']['AppBindings']['ShowBrowserSwitcher']();
}
